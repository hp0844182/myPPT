...
function Layout({ left, right, pin = 'left' }) {
  return (
    <div className="flex items-center h-screen px-4 mx-auto max-w-7xl sm:px-6 md:px-8 lg:grid lg:gap-8 lg:grid-cols-12">
      <div className="relative col-span-7 col-start-6 row-start-1 xl:col-start-7 xl:col-span-6">
