  ...
  return (
    <section id="performance">
      <div className="px-4 pt-4 mx-auto max-w-7xl sm:px-6 md:px-8">
        ...
        <BigText>tailwindcss只生成你所使用到的css.</BigText>
        <Paragraph>
      ...
      <GridLockup
        ...
        left={
          <div className="relative">
            <div
              ref={containerRef}
              className="relative pt-2 overflow-hidden shadow-xl bg-slate-800 sm:rounded-xl lg:grid lg:grid-cols-2 lg:grid-rows-1 dark:bg-slate-900/70 dark:backdrop-blur dark:ring-1 dark:ring-inset dark:ring-white/10"
            >
                          ...
                          if (token.content === '__CLASSES__') {
                            return (
                              ...
                              >
                                ...
                                <span className="-mx-px border" style={{ height: '1.125rem' }} />
                              </span>
                            )
                          }
                          return (
...
function Terminal({ rules }) {
  ...
  return (
    ...
    >
      <svg viewBox="0 -9 3 24" className="flex-none w-auto h-6 mr-3 overflow-visible text-pink-400">
        <path
          d="M0 0L3 3L0 6"
          fill="none"
          stroke="currentColor"
      ...
      <pre className="flex-auto text-sm leading-6">
        <code className="block pb-4 space-y-1">
          <div>
