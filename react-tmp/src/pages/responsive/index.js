...
function BrowserWindow({ size, onChange }) {
  ...
  return (
    <div className="relative">
      <motion.div
        className="max-w-full min-w-full shadow-xl sm:rounded-xl demo-sm:min-w-0 demo-sm:max-w-none"
        ...
        <div className="sm:rounded-xl ring-1 ring-slate-900/5">
          <div className="sm:rounded-t-xl bg-gradient-to-b from-white to-[#FBFBFB] dark:bg-none dark:bg-slate-700 dark:highlight-white/10">
            ...
            >
                ...
                {size !== undefined && (
                  <>
                    <svg
                      ...
                      height="24"
                      fill="none"
                      className="flex-none ml-4 text-slate-400 dark:text-slate-500"
                    >
                      <path
                        d="m15 7-5 5 5 5"
                        stroke="currentColor"
                    ...
                    <svg
                      ...
                      height="24"
                      fill="none"
                      className="flex-none ml-2 text-slate-400 dark:text-slate-500"
                    >
                      <path
                        d="m10 7 5 5-5 5"
                        stroke="currentColor"
              ...
              <div>
                <div className="flex items-center justify-center w-4/5 py-1 mx-auto text-xs font-medium leading-6 rounded-md bg-slate-100 ring-1 ring-inset ring-slate-900/5 dark:bg-slate-800 dark:text-slate-500">
                  <svg
                    viewBox="0 0 20 20"
                    fill="currentColor"
          ...
          <div className="relative pb-8 -mb-8 bg-white border-t border-slate-200 rounded-b-xl dark:bg-slate-800 dark:border-slate-900/50">
            <motion.iframe
              ref={iframeRef}
      ...
      >
        <motion.div
          ...
          className="absolute left-0 z-10 items-center justify-center hidden p-2 -mt-6 pointer-events-auto top-1/2 demo-sm:flex cursor-ew-resize"
          style={{ x }}
          onDragStart={() => {
...
export default function MobileFirst() {
  ...
  return (
    <section id="mobile-first" className="pt-4 overflow-hidden">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 md:px-8">
        ...
        />
        <BigText>响应式一切.</BigText>
        <Paragraph as="div">
          <p>
            不再需要在css文件中编写一堆媒体查询代码, 用tailwindcss直接在html中编写响应式设计代码.
          </p>
        </Paragraph>
      </div>
